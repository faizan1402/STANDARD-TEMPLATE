...
#include <vector>
 ...
 int main(){
 	         ...
 	         // Print assending order dictionary 

 	  // std :: map < string ,int ,std :: greater <string>> Map ; // so map function  key is unique and value can similar 

 	   // Or similar not any arguments pass

 	    std :: map <string,int ,std ::greater < >> Map; //Same output value is print decending order or reverse sorted order

 	   // std ::map <string ,int,std :: less < >> Map; //Means print assending order dictionary
